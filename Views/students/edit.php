                ...
                <form action="index.php?action=edit_data&id=<?php echo $row['id'];?>" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" value="<?php echo $row['firstname']." ".$row['lastname']; ?>" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="class">Class:</label>
                                <select name="class" id="class" class="form-control">
                                    <option <?php if($row['class_id']==1){?> selected="selected" <?php } ?> value="WEP2020-A">WEP2020-A</option>
                                    <option <?php if($row['class_id']==2){?> selected="selected" <?php } ?> value="WEP2020-B">WEP2020-B</option>
                                    <option <?php if($row['class_id']==3){?> selected="selected" <?php } ?> value="SNA2020">SNA2020</option>
                                </select>
                            </div>
                            <div class="form-group">
